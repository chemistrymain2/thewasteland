/datum/job/followers //do NOT use this for anything, it's just to store faction datums
	...
	forbids = "Collaborating, working with, or enabling organizations hostile to human life or society in general, such as the Enclave, the Legion, murderous raider gangs, et cetera. Treating raiders or enabling those who will go on to cause more harm is right out. Producing and selling drugs. Having sex all day while people die in front of you."
